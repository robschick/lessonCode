...
The script is called ```prepareDUMLData.R```, and it is in [this Box link](http://bit.ly/R-Code); download and open it up in RStudio.
...
> n.b. at the top of ```prepareDUMLData.R``` I load several libraries. You'll need these on your machine to get this code to run successfully.
