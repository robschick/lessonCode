...
## Github First
We start on GitHub, so this assumes you have no local code:

1. on GitHub, create a new repository. I typically add an R themed .gitignore file, and a README
2. copy its url (http or ssh) to clone it
3. Navigate to the parent folder, clone the repo (note this is critical so pay attention to where you want this)
...
## Local First
However, what if you already have a local repo that is not connected to GitHub? This is the situation we have here. 
